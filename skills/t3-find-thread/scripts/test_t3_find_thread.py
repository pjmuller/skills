...
def make_store(root: Path) -> Path:
    ...
    db.execute("INSERT INTO projection_projects VALUES ('p1','KampKompas','/Users/x/code/kampkompas','','', NULL)")
    db.execute("INSERT INTO projection_projects VALUES ('p2','DentAI','/Users/x/code/dentai','','', NULL)")
    threads = [
        ...
        ("t-dentai-9012", "p2", "Ahoy events for patient emails", "2026-08-20T09:00:00Z", "2026-08-20T12:00:00Z", None),
    ]
    ...
    messages = [
        ...
        ("m5", "t-dentai-9012", "assistant", "ahoy_events table has no rows for this tenant", "2026-08-20T09:30:00Z"),
    ]
...
class FindThreadTest(unittest.TestCase):
    ...
    def test_ranking_prefers_user_hits_and_more_terms(self):
        ...
        self.assertEqual(results[1]["thread_id"], "t-dentai-9012")  # assistant-only hit ranks lower

    def test_underscore_token_matches_bare_word(self):
        results = self.mod.json.loads(self.run_cli("search", "--format", "json", "ahoy"))["results"]
        self.assertEqual({r["thread_id"] for r in results}, {"t-referral-1234", "t-dentai-9012"})
    ...
    def test_project_fuzzy_and_typo(self):
        for needle in ("kampkompas", "KampKompa"):
    ...
    def test_md_table_shows_id_not_links(self):
        ...
        out = self.run_cli("search", "--project", "kampkompas", "ahoy")
    ...
    def test_web_links_flag_adds_browser_url(self):
        out = self.run_cli("search", "--project", "kampkompas", "--web-links", "ahoy")
    ...
    def test_peek_accepts_comma_separated_ids(self):
        payload = self.mod.json.loads(self.run_cli("--json", "peek", "t-referral-1234,t-dentai-9012"))
        self.assertEqual([p["thread_id"] for p in payload], ["t-referral-1234", "t-dentai-9012"])
