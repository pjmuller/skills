# Optional CodexBar setup

Install CodexBar as a quota display for the same native profiles used by T3 Code
and Codex. Follow the self-contained [codexbar-setup skill](../../skills/codexbar-setup/SKILL.md)
