...
| [agents-md](skills/agents-md/SKILL.md) | create or simplify a repo's AGENTS.md / CLAUDE.md, or write, prune and merge the global cross-project prompt ([template](skills/agents-md/global-template.md)) | global | `pnpm dlx skills add pjmuller/skills -s agents-md -g -y` (no command installer) |
